package com.intive.shopme.offer.validation;
...
public class LinkInTextValidator implements ConstraintValidator<LinkInTextCheck, String> {
    ...
    private static final Pattern[] URL_DETECTORS = new Pattern[]{
    ...
    public boolean isValid(String text, ConstraintValidatorContext context) {
        return text == null
                || Stream.of(URL_DETECTORS).noneMatch(pattern -> pattern.matcher(text).find());
    }
}
