...
alter table OFFER alter column CATEGORY_NAME type VARCHAR(255);
...
alter table OWNER alter column VOIVODESHIP_NAME type VARCHAR(255);
...
alter table USERS alter column VOIVODESHIP_NAME type VARCHAR(255);
